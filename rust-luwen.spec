...
%changelog
* Mon Dec 16 2024 Tenstorrent Releases <releases@tenstorrent.com> 0.4.6-1
- Separate tag and build job for Tito builds in Fedora workflow
  (palexson@tenstorrent.com)
- Enable rust-bitfield-struct package, remove --offline option from tito build
  (palexson@tenstorrent.com)
- Add bitfield-struct build dependency to spec file (palexson@tenstorrent.com)
- Uncomment build dependencies in spec file (palexson@tenstorrent.com)
- roll back version for tito (palexson@tenstorrent.com)
- modify fedora workflow file (palexson@tenstorrent.com)
- Add tenstorrent releases user and email to fedora release workflow
  (palexson@tenstorrent.com)
- Add Fedora 41 build process for testing (palexson@tenstorrent.com)
